...
export default function Historial({ trabajos, onCargarParaEditar, onEliminarTrabajo }) {
  ...
  return (
    <section className="bg-stitch-surface rounded-2xl p-4 md:p-6 border border-stitch-border shadow-xl max-w-[820px] mx-auto mt-4 md:mt-6 mb-10 text-stitch-text transition-colors duration-300">
          ...
          {trabajosFiltrados.map((t, index) => {
            ...
            return (
              <div
                ...
                className="cursor-pointer group bg-stitch-surface rounded-2xl border border-stitch-border/30 p-4 md:p-6 flex flex-col gap-4 md:gap-6 hover:border-stitch-primary/50 transition-colors"
              >
                <div className="flex justify-between items-start gap-3">
                  <div className="min-w-0 flex-1">
                    <h3 className="font-bold text-base md:text-[20px] text-stitch-text mb-1 truncate group-hover:text-stitch-primary transition-colors" title={t.nombre}>
                      {t.nombre}
                    </h3>
